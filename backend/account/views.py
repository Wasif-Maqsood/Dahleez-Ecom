...
#         reset_link = f"http://example.com/password-reset/{uid}/{token}/"
...
#     user = auth_views.password_reset_confirm(request, uidb64, token, post_reset_redirect='/password-reset-complete/')
#     return user
